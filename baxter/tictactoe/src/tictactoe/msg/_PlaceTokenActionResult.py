"""autogenerated by genpy from tictactoe/PlaceTokenActionResult.msg. Do not edit."""
import sys
...
class PlaceTokenActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "tictactoe/PlaceTokenActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tictactoe/PlaceTokenResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlaceTokenActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = tictactoe.msg.PlaceTokenResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = tictactoe.msg.PlaceTokenResult()
